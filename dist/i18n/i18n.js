...
const uz = {
    ...
    welcome_private: "Salom! Men UNO botiman 🎴\nMeni guruhga qo'shing va u yerda /uno buyrug'i bilan o'yinni boshlang.\nSizning kartalaringiz shu yerda, shaxsiy chatda ko'rinadi.",
    group_only: "Bu buyruq faqat guruhda ishlaydi.",
    need_private_start: "@{username}, avval menga shaxsiy xabar yozing (bot bilan chatni oching va /start bosing), aks holda sizga kartalarni yubora olmayman.",
...
const ru = {
    ...
    welcome_private: 'Привет! Я бот UNO 🎴\nДобавь меня в группу и запусти игру командой /uno.\nТвои карты будут показаны здесь, в личном чате.',
    group_only: 'Эта команда работает только в группе.',
    need_private_start: '@{username}, сначала напиши мне в личные сообщения (открой чат с ботом и нажми /start), иначе я не смогу отправлять тебе карты.',
...
const en = {
    ...
    welcome_private: "Hi! I'm the UNO bot 🎴\nAdd me to a group and start a game there with /uno.\nYour cards will be shown here, in this private chat.",
    group_only: 'This command only works in a group.',
    need_private_start: '@{username}, please message me privately first (open a chat with the bot and press /start), otherwise I can\'t send you your cards.',
...
function colorLabel(lang, color) {
